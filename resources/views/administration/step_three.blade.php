						...
						<div class="form-group row">
							...
							<div class="form-group row">
								<label  class="col-sm-4 control-label">Upazilla/Thana:<span
									...
									<div class="col-sm-8">
										<div class="controls">
											<select style="width: 100%;" required class="form-control" name="paressent_thana_id" id="paressent_thana_id">
											</select> 
										</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="form-group row">
										<label  class="col-sm-4 control-label">Upazilla/Thana:<span
											...
											<div class="col-sm-8">
												<div class="controls">
													<select style="width: 100%;" required class="form-control" name="parmanent_thana_id" id="parmanent_thana_id">
